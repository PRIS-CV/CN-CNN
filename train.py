...
def main():
    ...
    parser = argparse.ArgumentParser(description='FGVC')
    ...
    ### setup exp_dir
    exp_name = "FGVC_{}_{}".format(args.model, args.dataset)
    ...
    model_dir = os.path.expanduser(os.getenv('TORCH_HOME', '~/torch/checkpoints'))
